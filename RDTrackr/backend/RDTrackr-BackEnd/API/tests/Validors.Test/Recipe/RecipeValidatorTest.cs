...
namespace Validors.Test.Recipe
{
    public class RecipeValidatorTest
    {
        ...
        public void Error_Empty_Title(string title)
        {
            ...
            result.IsValid.ShouldBeFalse();
            result.Errors.ShouldHaveSingleItem();
            result.Errors.ShouldContain(error => error.ErrorMessage.Equals(ResourceMessagesException.RECIPE_TITLE_EMPTY));
        }
        ...
        public void Error_Empty_Ingredients()
        {
            ...
            result.IsValid.ShouldBeFalse();
            result.Errors.ShouldHaveSingleItem();
            result.Errors.ShouldContain(error => error.ErrorMessage.Equals(ResourceMessagesException.AT_LEAST_ONE_INGREDIENT));
        }
        ...
        public void Error_Empty_Instructions()
        {
            ...
            result.IsValid.ShouldBeFalse();
            result.Errors.ShouldHaveSingleItem();
            result.Errors.ShouldContain(error => error.ErrorMessage.Equals(ResourceMessagesException.AT_LEAST_ONE_INSTRUCTION));
        }
        ...
        public void Error_Empty_Value_Ingredients(string ingredient)
        {
            ...
            result.IsValid.ShouldBeFalse();
            result.Errors.ShouldHaveSingleItem();
            result.Errors.ShouldContain(error => error.ErrorMessage.Equals(ResourceMessagesException.INGREDIENT_EMPTY));
        }
        ...
        public void Error_Same_Step_Instructions()
        {
            ...
            result.IsValid.ShouldBeFalse();
            result.Errors.ShouldHaveSingleItem();
            result.Errors.ShouldContain(error => error.ErrorMessage.Equals(ResourceMessagesException.TWO_OR_MORE_INSTRUCTIONS_SAME_ORDER));
        }
        ...
        public void Error_Negative_Step_Instructions()
        {
            ...
            result.IsValid.ShouldBeFalse();
            result.Errors.ShouldHaveSingleItem();
            result.Errors.ShouldContain(error => error.ErrorMessage.Equals(ResourceMessagesException.NON_NEGATIVE_OR_ZERO_INSTRUCTION_STEP));
        }
        ...
        public void Error_Empty_Value_Instructions(string instruction)
        {
            ...
            result.IsValid.ShouldBeFalse();
            result.Errors.ShouldHaveSingleItem();
            result.Errors.ShouldContain(error => error.ErrorMessage.Equals(ResourceMessagesException.INSTRUCTION_EMPTY));
        }
        ...
        public void Error_Instructions_Too_Long()
        {
            ...
            result.IsValid.ShouldBeFalse();
            result.Errors.ShouldHaveSingleItem();
            result.Errors.ShouldContain(error => error.ErrorMessage.Equals(ResourceMessagesException.INSTRUCTION_EXCEEDS_LIMIT_CHARACTERS));
        }
